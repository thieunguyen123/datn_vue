...
const urlGetBadmintonCourtOfOwner =
...
export default {
  ...
  methods: {
    ...
    async getBadmintonCourtOfOwner() {
      await axios
        .get(urlGetBadmintonCourtOfOwner, {
          headers: {
        ...
        .then((response) => {
          this.badmintonCourts = response.data.allBadmintonCourtOfOwner;
      ...
      await axios
        ...
        .then(() => {
          ElNotification({
            ...
            message: "Delete court is successfully",
        ...
        .catch((error) => {
          ElNotification({
            ...
            message: "Delete court is failed",
            position: "bottom-right",
            type: "error",
            duration: "3000",
          });
